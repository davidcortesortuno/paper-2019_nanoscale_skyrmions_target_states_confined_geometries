...
simulation () {
    ...
    python ../hexagonal_neb_fidimag.py \
        ...
        --mu_s 3 \
        --k_u 0.406 \
        --interpolation "../../relaxation/hexagons_size_variation_pinned_boundary_DT/npys/2Dhex_hexagon_R${R}nm_PdFe-Ir_1-sk-down_B${B}mT_npys" \
                         26 \
                         "../../relaxation/hexagons_size_variation_pinned_boundary_DT/npys/2Dhex_hexagon_R${R}nm_PdFe-Ir_fm-up_B${B}mT_npys" \
        --nebm_k 1e4 \
